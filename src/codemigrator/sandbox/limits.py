...
def validation_directory_exceeds_quota(root: Path | str, limits: ResourceLimits) -> bool:
    """Detect file and aggregate growth before it can exceed the declared budget."""
